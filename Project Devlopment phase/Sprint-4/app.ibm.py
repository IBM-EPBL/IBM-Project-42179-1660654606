...
API_KEY = "CJPigMgSVQrtg4wllkT5Dw1fpJttb_bSahoPVeT3jqJ8"
...
def predict():
    if request.method=="POST":
        ...
        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/58d72b2a-2777-43d8-a2f6-7948985d6454/predictions?version=2022-11-14', json=payload_scoring,
